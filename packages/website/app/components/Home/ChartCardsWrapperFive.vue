    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <HomeChartCard v-bind="card">
          <HomeIllustrationsLineChartFive v-if="card.id === 'line-charts'" />
          <HomeIllustrationsBarChartFive v-else-if="card.id === 'bar-charts'" />
          <HomeIllustrationsAreaChartFive v-else-if="card.id === 'area-charts'" />
          <HomeIllustrationsDonutChartFive v-else-if="card.id === 'donut-charts'" />
        </HomeChartCard>
      </NuxtLink>
    </div>
  </div>
