    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <HomeChartCard v-bind="card">
          <HomeIllustrationsLineChartFour v-if="card.id === 'line-charts'" />
          <HomeIllustrationsBarChartFour v-else-if="card.id === 'bar-charts'" />
          <HomeIllustrationsAreaChartFour v-else-if="card.id === 'area-charts'" />
          <HomeIllustrationsDonutChartFour v-else-if="card.id === 'donut-charts'" />
        </HomeChartCard>
      </NuxtLink>
    </div>
  </div>
