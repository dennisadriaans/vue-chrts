---
title: Gantt Charts
description: A Gantt Chart or timeline that displays a list of events in chronological order.
navigation:
  icon: i-lucide-chart-no-axes-gantt
seo:
  description: Learn how to implement and customize Gantt Charts and timeline visualizations for project scheduling in your Nuxt application.
---
...
<BlocksTimelineBasic class="w-full p-8 bg-elevated/50" />
:::
```vue [Basic.vue]
