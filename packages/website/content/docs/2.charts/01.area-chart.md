...
<BlocksAreaChartsMultipleLines class="w-full p-4 bg-elevated/50" />
:::
```vue [MultiLines.vue]
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksAreaChartsSingleLine class="w-full p-4 bg-elevated/50" />
:::
```vue [SingleLine.vue]
<script lang="ts" setup>
defineOptions({
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksAreaChartsBasic class="w-full p-4 bg-elevated/50" :show-title="true"  />
:::
```vue [Basic.vue]
<script lang="ts" setup>
import { useResponsiveHeight } from '~/composables/useResponsiveHeight'
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<DocsChartsAreaStep class="w-full p-4 bg-elevated/50" />
:::
```vue [Step.vue]
<script lang="ts" setup>
defineOptions({
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<DocsChartsAreaStacked class="w-full p-4 bg-elevated/50" />
:::
```vue [Stacked.vue]
<script lang="ts" setup>
defineOptions({
