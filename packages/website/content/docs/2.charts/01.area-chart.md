---
title: Area Chart
description: Learn how to implement and customize Area Charts in your Nuxt application using Vue charts.
navigation:
  icon: i-lucide-area-chart
seo:
  description: Learn how to implement and customize Area Charts in your Nuxt application with multiple lines, stacked areas, and step visualizations.
---

The `AreaChart` component is a powerful addition to the Vue charts library, visualizing time series or categorical data as filled line charts. <a href="https://nuxtcharts.com/charts" target="_blank" rel="">Examples ↗</a>

## Basic Usage

::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksAreaChartsMultipleLines class="w-full p-4 bg-elevated/50 dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksAreaChartsSingleLine class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksAreaChartsBasic class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" :show-title="true"  />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<DocsChartsAreaStep class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<DocsChartsAreaStacked class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
