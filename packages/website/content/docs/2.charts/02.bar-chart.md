...
<BlocksBarChartsVertical class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksBarChartsStackedHorizontal class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksBarChartsGroup class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksBarChartsStacked class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksBarChartsWithValueLabel class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
<template>
  <div>
    <BarChart :height="300" :y-axis="['desktop', 'mobile']" v-bind="options" />
  </div>
</template>
```
