...
<BlocksLineChartsMultiLinesLinear class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksLineChartsMultiLines class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksLineChartsSingleLine class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<BlocksLineChartsDashArray class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
