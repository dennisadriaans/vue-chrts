...
<DocsDottedMapBasic class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
::code-group
:::code-preview{icon="i-lucide-eye" label="Preview"}
<DocsDottedMapDiagonal class="w-full p-4 bg-elevated/50  dark:bg-elevated/20" />
:::
...
<DottedMap :map-height="50" :dot-size="0.3" />
```

```vue [High Resolution]
<!-- Small dots with more spacing -->
<DottedMap :map-height="75" :dot-size="0.3" />
```
