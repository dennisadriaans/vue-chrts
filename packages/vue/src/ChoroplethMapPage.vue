...
const areaColor = (d: any) => {
  const isHovered = hoveredArea.value === d.id || hoveredArea.value === d.properties?.id;
  ...
  <div class="min-h-screen bg-white">
    ...
    <div class="p-8 max-w-7xl mx-auto">
      <div class="flex flex-col md:flex-row justify-between items-start mb-6 border-b border-gray-100 pb-4">
        <div>
            <h2 class="text-xl font-medium text-gray-800 border-b-2 border-dashed border-gray-300 inline-block">Event count</h2>
            <span class="text-xl font-medium text-gray-800 mx-2">by</span>
            <h2 class="text-xl font-medium text-gray-800 border-b-2 border-dashed border-gray-300 inline-block">Country</h2>
        </div>
        
        <div class="flex items-center gap-2 border border-blue-500 rounded-full px-3 py-1 text-blue-600 bg-blue-50/50">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div class="lg:col-span-2 relative">
            ...
            <div class="absolute right-4 bottom-4 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
        ...
        <div class="lg:col-span-1">
            <div class="flex justify-between text-xs font-bold text-gray-400 mb-4 tracking-wider uppercase">
                <span class="border-b-2 border-dashed border-gray-300 pb-1">Country</span>
                <span class="border-b-2 border-dashed border-gray-300 pb-1">Event Count</span>
            </div>
