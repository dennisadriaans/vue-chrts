...
import { VisXYContainer, VisBulletLegend, VisTooltip, VisTimeline, VisAxis } from '@unovis/vue'
...
<template>
  <div class="max-w-7xl mx-auto p-16">
    ...
    <VisTimeline :rowHeight="100" :x="x" :length="length" :type="type" :color="color" :labelWidth="labelWidth" :showLabels="true" />
